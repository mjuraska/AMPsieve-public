...
#
# DESCRIPTION: Generate violin plot of HVTN 703 parscore1 and 
#              parscore2 values on log scale by treatment group
# 
# CODED BY: Erika Rudnicki
#
# SAVED AS: /trials/vaccine/p703/analysis/sieve/code
#
# INPUT: 
#   ../adata/v703_survival_wk80_tau_sieve_v5_cam.csv
#
# OUTPUT: 
#   ../figures/descriptive/v703_violin_pred.prob.res.mf.pdf
#   ../figures/descriptive/v703_violin_pred.ic80.mf.pdf
#
# MAINTENANCE HISTORY:
...
# setwd("/trials/vaccine/p703/analysis/sieve/code")
...
# load data
dat <- read.csv("../adata/amp_sieve_v703_marks_final_v4a.csv")
...
for (i in 1:length(plots)){
  ...
  pdf(paste0("../figures/descriptive/v703violin", plots2[i], "_20092022.pdf"), width=8, height=8)
