...
# load data
dat1 <- read.csv("../adata/amp_sieve_v704_marks_final_v4.csv")
...
for (i in 1:length(plots)){
  pdf(paste0("../figures/descriptive/v704_violin_d230_gmt80mf", "20SEP2022.pdf"), width=8, height=6)
...
for (i in 1:length(plots)){
  pdf(paste0("../figures/descriptive/v704_violin_d230_gmt80mf_v2", "20SEP2022.pdf"), width=8, height=6)
