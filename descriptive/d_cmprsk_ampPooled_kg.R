...
# input file name
dataFile <- "amp_sieve_pooled_marks_final_v4.csv"

# output file names
cuminc.csvFile <- c("v703and704_cmprisk_cuminc_mf_20092022.csv", "v703and704_cmprisk_cuminc_ms_20092022.csv", "v703and704_cmprisk_cuminc_ls_20092022.csv")
cir.csvFile <- c("v703and704_cmprisk_cir_mf_20092022.csv", "v703and704_cmprisk_cir_ms_20092022.csv", "v703and704_cmprisk_cir_ls_20092022.csv")
