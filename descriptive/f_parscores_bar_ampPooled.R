...
#
# DESCRIPTION: Generate ordered bar plots of AMP par score 3 
...
#
# OUTPUT: 
#   ../figures/descriptive/v704and703barparscore3.mf.pdf
#
# MAINTENANCE HISTORY:
...
for (i in 1:length(plots)){
  CairoPDF(paste0("../figures/descriptive/v704and703bar", plots2[i], ".pdf"), width=8, height=8)
