...
adataDir <- "../adata"
adataFile1 <- "amp_sieve_v704_marks_final_v4.csv"
adataFile2 <- c("v704_cmprisk_cir_mf_20092022.csv", "v704_cmprisk_cir_ms_20092022.csv", "v704_cmprisk_cir_ls_20092022.csv")

# output directory and file names
pdfDir <- "../figures/cmprsk"
pdfFile <- c("v704_efficacy_cmprsk_mf_20092022.pdf", "v704_efficacy_cmprsk_ms_20092022.pdf", "v704_efficacy_cmprsk_ls_20092022.pdf")
