...
#
# DESCRIPTION: Generate ordered bar plots of HVTN 703 par score 3 
...
#
# OUTPUT: 
#   ../figures/descriptive/v703barparscore3.mf.pdf
#
# MAINTENANCE HISTORY:
...
for (i in 1:length(plots)){
  CairoPDF(paste0("../figures/descriptive/v703bar", plots2[i], "_20092022.pdf"), width=8, height=8)
