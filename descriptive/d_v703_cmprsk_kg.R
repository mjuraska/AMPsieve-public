...
# 26Aug2022      Kevin Gillespie    Re-run on new input data & modified code
#----------------------------------------------------------------------------------------
...
# input file name
dataFile <- "amp_sieve_v703_marks_final_v4.csv"

# output file names
cuminc.csvFile <- c("v703_cmprisk_cuminc_mf_20092022.csv", "v703_cmprisk_cuminc_ms_20092022.csv", "v703_cmprisk_cuminc_ls_20092022.csv")
cir.csvFile <- c("v703_cmprisk_cir_mf_20092022.csv", "v703_cmprisk_cir_ms_20092022.csv", "v703_cmprisk_cir_ls_20092022.csv")
