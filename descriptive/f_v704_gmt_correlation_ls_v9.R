...
# load data
dat <- read.csv("../adata/amp_sieve_v704_marks_final_v9.csv")

# dat$hdist.zspace.sites.binding.all.ls <- log10(dat$hdist.zspace.sites.binding.all.ls)
colnames_pairs <- c(
...
# plot
cairo_pdf(paste0('../figures/descriptive/v704_gmt_correlation_ls_v9a.pdf'),width=11,height=8.5)

draw.plot(dat=datplot,
          covars=c("tx"),
          vars=c("parscore1.ls", "parscore2.ls", "epitope.dist.b.ls", 
