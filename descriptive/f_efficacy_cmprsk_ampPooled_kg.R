#----------------------------------------------------------------------------------------
# PROGRAM: f_efficacy_cmprsk_ampPooled.R
#
...
#
# OUTPUT: 
#     ../figures/cmprsk/v704and703_efficacy_cmprsk.pdf
#
# MAINTENANCE HISTORY:
...
adataDir <- "../adata"
adataFile1 <- "amp_sieve_pooled_marks_final_v4.csv"
adataFile2 <- c("v703and704_cmprisk_cir_mf_20092022.csv", "v703and704_cmprisk_cir_ms_20092022.csv", "v703and704_cmprisk_cir_ls_20092022.csv")

# output directory and file names
pdfDir <- "../figures/cmprsk"
pdfFile <- c("v703and704_efficacy_cmprsk_mf_20092022.pdf", "v703and704_efficacy_cmprsk_ms_20092022.pdf", "v703and704_efficacy_cmprsk_ls_20092022.pdf")
