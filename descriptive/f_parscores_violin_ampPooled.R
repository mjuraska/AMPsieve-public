#----------------------------------------------------------------
# PROGRAM: f_parscores_violin_ampPooled.R
#
# DESCRIPTION: Generate violin plot of AMP parscore1 and 
...
#
# OUTPUT: 
#   ../figures/descriptive/v704and703_violin_pred.prob.res.mf.pdf
#   ../figures/descriptive/v704and703_violin_pred.ic80.mf.pdf
#
# MAINTENANCE HISTORY:
...
# load data
dat <- read.csv("../adata/v704and703_survival_wk80_tau_sieve_v5_cam_er.csv")
...
for (i in 1:length(plots)){
  pdf(paste0("../figures/descriptive/v704and703violin", plots2[i], ".pdf"), width=8, height=8)
