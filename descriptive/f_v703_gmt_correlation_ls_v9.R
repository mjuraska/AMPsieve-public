...
# load data
dat <- read.csv("../adata/amp_sieve_v703_marks_final_v9.csv")
colnames_pairs <- c(
...
cairo_pdf(paste0('../figures/descriptive/v703_gmt_correlation_ls_v9a.pdf'),width=11,height=8.5)

draw.plot(dat=datplot,
          covars=c("tx"),
          vars=c("parscore1.ls", "parscore2.ls", "epitope.dist.c.ls", 
