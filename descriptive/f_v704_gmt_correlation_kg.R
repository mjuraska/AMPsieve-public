...
#
# Input:
#   ../adata/amp_sieve_v704_marks_final_v5.csv
#
# Output:
#   ../figures/adhoc/v704_gmt_correlation_kg.pdf
#
# Code History
# ---------------------------------------------------------------------------------------
...
if(T){#Extra Functions
  ...
  draw.plot=function(dat,vars,covars,labels,lgnd,title){  
    ...
    pairs3(df, gap = 0, lower.panel1 = panel.diag, lower.panel2 = panel.smooth, type.matrix = type.matrix,
...
# load data
dat <- read.csv("../adata/amp_sieve_v704_marks_final_v5.csv")
colnames_pairs <- c(
...
# plot
pdf(paste0('../figures/descriptive/v704_gmt_correlation_kg.pdf'),width=11,height=8.5)
