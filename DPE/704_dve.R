...
save( dve_results, file = file.path( tablesOutDir, "HVTN704_DVE_results_by_feature.Rda" )) 
          
### Forest plot
pdf( file = file.path( figuresOutDir, "HVTN704_DVE_results_by_feature_forest_plot.pdf" ), width = 6, height = 6)
